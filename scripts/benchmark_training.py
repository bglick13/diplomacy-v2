...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="Number of rollout batches to keep queued ahead of the trainer.",
    )
    parser.add_argument(
        "--policy-lag",
        type=int,
        default=1,
        help="Maximum allowed lag (in steps) between policy version and training data.",
    )
    parser.add_argument(
        "--compact-prompts",
        action="store_true",
        help="Use compact prompt template for rollouts.",
    )
